...
class Contact {
  ...
  factory Contact.fromJson(Map<String, dynamic> jsonData) {
    return Contact(
      ...
      photoPath: jsonData['photoPath'] as String?,
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    focusedBorder: UnderlineInputBorder(
                      borderSide:
                          BorderSide(color: Color(0xFF476BEC), width: 2.0),
                    ),
                  ),
    ...
    return Card(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: const Color(0xFFFFFFFF), // Equivalent to #FFF
        ...
        child: ExpansionTile(
          title: Text(widget.contact.name,
              style: const TextStyle(
                ...
                // Equivalent to #000 or black
                fontFamily: 'Pretendard Variable',
                // Ensure the font is included in your project
                fontSize: 18.0,
                // Font size
                fontStyle: FontStyle.normal,
                // Normal font style
                fontWeight: FontWeight.w700,
                // Font weight 700 is equivalent to FontWeight.w700
                height: 22 / 18,
                // Line height divided by font size for line-height percentage
          ...
          subtitle: Text(
            ...
            style: const TextStyle(
              ...
              // Font weight 300 is equivalent to FontWeight.w300
              height: 22 / 14,
              // Line height divided by font size for line-height percentage
              letterSpacing: -0.408, // Letter spacing
            ),
          ...
          trailing: widget.isExpanded ? null : _buildTrailingIcons(),
                      ...
                      ElevatedButton(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            // Optional: provide some space between the icon and the text
                            Expanded(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: const TextStyle(
                        ...
                        // var(--gray, #979797)
                        fontFamily: 'Pretendard Variable',
                        // Make sure this font is added to your pubspec.yaml
                        fontSize: 20.0,
                        // font-size: 20px
                        fontStyle: FontStyle.normal,
                        // font-style: normal
                        ...
                        // font-weight: 500
                        height: 1.1,
                        // line-height: 110% (approximation using height as a multiplier)
                        letterSpacing: -0.408, // letter-spacing: -0.408px
                      ),
                      prefixIcon: Padding(
                        padding: EdgeInsets.all(10.0),
                        // padding을 조절하여 아이콘의 크기를 조정
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: ExpandableContactCard(
                        ...
                        isExpanded: _currentlyExpanded == index,
                        index: index,
                        onExpansionChanged: (expanded) => _handleTileExpansion(index, expanded),
                        // 나머지 필요한 매개변수 추가...
                      ),
                    );
                  },
